...
%	\includegraphics[height=5cm]{example-image}
	\[\xymatrix@C=0.3em{
		 & & & \ar[d]_{x = 0,~y = 0,~z = b_{0} + 1} a = a_{0},b = b_{0}, c = c_{0} \\
...
%	\[\xymatrix{
%		a = a_{0}, b = b_{0}, c = c_{0}  \ar[d] \ar[dr] \ar[drr] &   &   \\
%		B                         & C & D } \]
	\caption{Execution graph of the program presented in listing~\ref{lst:program-analysis:symbolic}.}
